...
CLAUDE_SANDBOX_URL_INTL=http://claude-sandbox-intl:3100
AGENTIC_INTL_V1_USE_INTL_SANDBOX=false
AGENTIC_INTL_V2_RERANK_ENABLED=true
AGENTIC_INTL_V2_COUNTRY_GUARDRAIL_MODE=enforce
...
CALENDAR_EXTRACT_S3_REGION=us-east-1
CALENDAR_EXTRACT_JOB_TTL_HOURS=720
CALENDAR_EXTRACT_TIMEOUT_SECONDS=90
EOF
