...
import { Upload, CheckCircle2, AlertCircle, Database, FileSpreadsheet, Loader2 } from 'lucide-react'
import { cn } from '@/lib/utils'
import { useMovieMasterSeed } from '@/hooks/useMovieMasterSeed'
...
function MovieMasterSeedPage() {
  const { loading, result, error, uploadFile, fetchCount, reset } = useMovieMasterSeed()
  ...
  return (
    <div className="max-w-2xl mx-auto flex flex-col gap-6 py-6">
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <h1 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50">Seed Movie Master</h1>
          <p className="mt-0.5 text-sm text-zinc-500 dark:text-zinc-400">
            Upload the Movie Master CSV or Excel file to populate the database.
            New entries are inserted; existing entries are updated by ID.
            {currentCount === 0 && (
